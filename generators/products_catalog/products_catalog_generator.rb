class ProductsCatalogGenerator < Rails::Generator::Base
  def manifest
    record do |m|
      ...
      # Views
      m.directory "app/views/admin/product_categories"
      m.directory "app/views/admin/products"
      ...
      m.file "views/admin/product_categories/show.html.erb", "app/views/admin/product_categories/show.html.erb"
